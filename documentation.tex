...
\paragraph{\cudaglobal \void FillSparse(\ptrint , \ptrint , \int, \cuDoubleComplex , \typeinttwoptr , \int , \int , \const \double ) \\ \\ }
\noindent\textbf{Parameters}:
\begin{description}
...
\item[\typeinttwoptr H$\_$pos] An empty array that will store the Hamiltonian positions
...
Other things:
\begin{itemize}
\item{H$\_$pos is a \typeinttwoptr because this makes later functions easier. The first \ptrint is the row index and the second is the column.}
...
\paragraph{\cudaglobal \void CompressSparse(\cuDoubleComplex , \typeinttwoptr , \hamstruct , \int , \const \int ) \\ \\}
\noindent\textbf{Parameters}:
\begin{description}
\item[\cuDoubleComplex H$\_$vals] The array of Hamiltonian values
\item[\typeinttwoptr H$\_$pos] The array of Hamiltonian positions in the columns
...
\paragraph{\cudaglobal \void FullToCOO(\int , \cuDoubleComplex , \typeinttwoptr , \cuDoubleComplex , \ptrint , \ptrint, \long) \\ \\}
\noindent\textbf{Parameters}:
\begin{description}
\item[\int num$\_$Elem] The number of nonzero elements
\item[\cuDoubleComplex H$\_$vals] The array of the Hamiltonian values
\item[\typeinttwoptr H$\_$pos] The array of the Hamiltonian positions
...
\itme[conv$\_$req]{The convergence requirement for the eigenvalues between iterations}
\end{description}
